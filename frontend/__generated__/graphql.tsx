...
export interface ColumnUpdateManyWithoutBoardInput {
  create?: Maybe<ColumnCreateWithoutBoardInput[]>;

  delete?: Maybe<ColumnWhereUniqueInput[]>;

  connect?: Maybe<ColumnWhereUniqueInput[]>;

  set?: Maybe<ColumnWhereUniqueInput[]>;

  disconnect?: Maybe<ColumnWhereUniqueInput[]>;

  update?: Maybe<ColumnUpdateWithWhereUniqueWithoutBoardInput[]>;

  upsert?: Maybe<ColumnUpsertWithWhereUniqueWithoutBoardInput[]>;

  deleteMany?: Maybe<ColumnScalarWhereInput[]>;

  updateMany?: Maybe<ColumnUpdateManyWithWhereNestedInput[]>;
}
...
export interface ColumnScalarWhereInput {
  ...
  AND?: Maybe<ColumnScalarWhereInput[]>;

  OR?: Maybe<ColumnScalarWhereInput[]>;

  NOT?: Maybe<ColumnScalarWhereInput[]>;
}
...
export type CreateBoardMutation = {
  ...
  createBoard: CreateBoardCreateBoard;
};

export type CreateBoardCreateBoard = {
  __typename?: "Board";
...
export type UpdateBoardVariables = {
  id: string;
  name?: Maybe<string>;
  query?: Maybe<string>;
};
...
export type UpdateBoardMutation = {
  ...
  updateBoard: Maybe<UpdateBoardUpdateBoard>;
};

export type UpdateBoardUpdateBoard = {
  __typename?: "Board";
...
`;
export class CreateBoardComponent extends React.Component<
  Partial<ReactApollo.MutationProps<CreateBoardMutation, CreateBoardVariables>>
> {
  render() {
    return (
      <ReactApollo.Mutation<CreateBoardMutation, CreateBoardVariables>
...
export type CreateBoardProps<TChildProps = any> = Partial<
  ReactApollo.MutateProps<CreateBoardMutation, CreateBoardVariables>
> &
  TChildProps;
...
>;
export function CreateBoardHOC<TProps, TChildProps = any>(
  operationOptions:
...
`;
export class UpdateBoardComponent extends React.Component<
  Partial<ReactApollo.MutationProps<UpdateBoardMutation, UpdateBoardVariables>>
> {
  render() {
    return (
      <ReactApollo.Mutation<UpdateBoardMutation, UpdateBoardVariables>
...
export type UpdateBoardProps<TChildProps = any> = Partial<
  ReactApollo.MutateProps<UpdateBoardMutation, UpdateBoardVariables>
> &
  TChildProps;
...
>;
export function UpdateBoardHOC<TProps, TChildProps = any>(
  operationOptions:
    | ReactApollo.OperationOption<
        TProps,
        UpdateBoardMutation,
